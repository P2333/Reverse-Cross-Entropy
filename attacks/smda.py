...
def smda(model, x, hps, RCE_train, y,epochs=1.0, eps=1.0, clip_min=0.0,
    ...
    def _fn(i):
        ...
        xadv = _smda_impl(model, xi, hps, RCE_train, yi, epochs=epochs, eps=eps,
...
def _smda_impl(model, xi, hps, RCE_train, yi, epochs, eps=1.0, clip_min=0.0, clip_max=1.0,
               min_proba=0.0):
